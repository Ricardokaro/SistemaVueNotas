<template>
  <v-layout align-start>
    <v-flex>
      ...
      <v-data-table :headers="headers" :items="areas" :search="search" class="elevation-1">
  ...
  export default {             
      ...
      methods:{          
          listar(){  
            ...
            axios.get('api/Areas/Listar',configuration).then(function(response){               
          ...
          activar(){
             ...
             let header = {"Authorization" : "Bearer " + this.$store.state.token};
             let configuration = {headers : header};
                axios.put('api/Areas/Activar/' + this.adId,{}, configuration).then(function(response){
                    me.adModal = 0;
                    me.adAccion = 0;
                    me.adNombre = "";
                    me.adId = "";
          ...
          desactivar(){
              ...
              let header = {"Authorization" : "Bearer " + this.$store.state.token};
              let configuration = {headers : header};
                axios.put('api/Areas/Desactivar/' + this.adId,{}, configuration).then(function(response){
                    me.adModal = 0;
                    me.adAccion = 0;
                    me.adNombre = "";
                    me.adId = "";
